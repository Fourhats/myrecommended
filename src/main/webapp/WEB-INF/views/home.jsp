...
<div class="section no-pad-bot" id="index-banner">
  ...
  <div class="container">
    <div class="section">
	<h2 class="header col s12 light center" style="font-size: 30px;">Contratar servicios nunca fue tan fácil</h2>
      <!--   Icon Section   -->
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Con tu ubicación y el especialista que busques vamos a seleccionar los mejores candidatos disponibles</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Revisa los recomendados que quieras entre los cientos que tenemos disponibles en nuestra red de profesionales</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Contactá al recomendado que buscabas y resolvé tus problemas más rápido que nunca ;)</p>
          </div>
        </div>
      </div>
